...
export function Programacao({ data }: Props) {
  ...
  // All program days on one or more pages
  // We render all days in a single flex container — Playwright handles page-breaks
  return (
    <div style={page} className="page-break">
      ...
      <div style={bodyStyle}>
        {data.course.programDays.map((day, dayIdx) => (
