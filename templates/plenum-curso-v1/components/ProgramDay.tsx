...
const s = {
  ...
  tag: {
    display: 'inline-block', background: 'var(--color-primary, #3b82f6)', color: '#fff',
  ...
  underline: {
    width: '25mm', height: '1mm', background: 'var(--color-primary, #3b82f6)', borderRadius: '1mm', marginBottom: '3mm',
  } as React.CSSProperties,
  desc: { fontSize: '13pt', color: '#64748b', lineHeight: 1.5, marginBottom: '3mm' } as React.CSSProperties,
  topicCard: {
    border: '1px solid #e2e8f0', borderLeft: '3px solid var(--color-primary, #3b82f6)', borderRadius: '4px',
